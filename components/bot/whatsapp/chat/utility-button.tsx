...
function WhatsAppUtilityButton({ onClick, Icon, label, className = '', type = 'blueDashed', size = 'normal' }: Props) {
    ...
    return (
        <div
            onClick={onClick}
            className={`flex justify-center min-w-64 items-center rounded-md w-fit mt-2 cursor-pointer bg-transparent mr-auto ${className} ${TYPES[type]}`}
        >
